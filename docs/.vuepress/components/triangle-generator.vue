<template>
  <div>
    <div class="triangle-generator-wrap">
      <div class="tool-box">
    ...
    <div style="width:100%;">
      ...
      <div class="language-css extra-class">
        <pre
          class="language-css"
        ><code ref="code-container" v-html="cssCode"></code></pre>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  border-color: ${this.colors};
      ...
      this.cssCode = Prism.highlight(outputCssStr, Prism.languages.css);
    },
